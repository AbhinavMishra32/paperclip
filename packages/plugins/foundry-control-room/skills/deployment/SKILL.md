...
4. Call `foundry.control-room:deploy_project`. It pushes the committed HEAD and performs a non-interactive authenticated production deployment against the existing configured Vercel project.
